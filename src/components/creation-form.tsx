...
export default function CreationForm() {
  ...
  const mutatator = useMutation(
    ...
    },
    {
      ...
      onSettled: () => {
        setExpanded(false);
        queryClient.invalidateQueries("lastAdded");
    ...
    >
      ...
      >
        <FormItemWrapper>
          ...
          <label className="label" htmlFor="urlinput" title="Any valid url">
            https://example.com/{" "}
          </label>
          <LoadingOverlay loading={loading}>
            <CreateButton active={true}>CREATE</CreateButton>
          </LoadingOverlay>
        </FormItemWrapper>
